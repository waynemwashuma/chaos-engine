...
export function initCanvas2DGeometry(geometry) {
  geometry.drawable = new Path2D()
  assert(geometry.attributes['position'], "`initCanvas2DGeometry()` requires the position attribute of the geometry to be set.")
  vertices(
    geometry.drawable,
